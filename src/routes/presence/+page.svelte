  ...
  const offerings = [
    {
      ...
      desc: "A strategic blueprint for your website that aligns business goals, user needs, and market position.",
    },
    {
      title: "UX Architecture",
      desc: "Information architecture and user flows designed to guide visitors toward meaningful action.",
    },
    {
      title: "Conversion Strategy",
      desc: "Structure, content, and design decisions engineered to turn visitors into qualified opportunities.",
    },
    {
      title: "Copywriting",
      desc: "Words that communicate your value with precision, clarity, and persuasive weight.",
    },
    {
      title: "Design System",
      desc: "A cohesive visual language that makes your brand consistent, scalable, and recognisable.",
    },
    {
      title: "Visual Identity Refinement",
      desc: "Elevating your existing brand identity to match the quality of your work and ambition.",
    },
    {
      title: "Trust Asset Creation",
      desc: "Case studies, testimonials, credentials, and proof points that build confidence before the first conversation.",
    },
    {
      title: "Case Study Development",
      desc: "Structured narratives that demonstrate your capability through outcomes, not promises.",
    },
  ];
...
<Seo
  title="Premium Website & Brand Transformation | Presence"
  description="Transform your website and brand into a powerful trust-building asset that attracts opportunities and converts visitors into clients."
/>
...
<div class="bg-[#050505] text-white">
  ...
  >
    ...
    <div class="max-w-5xl mx-auto text-center relative z-10">
      ...
      >
        Look as good as<br />
        <span class="italic text-white/40">you actually are.</span>
      </h1>
      <p
        id="hero-subline"
        class="text-lg md:text-xl text-white/50 max-w-3xl mx-auto mt-12 font-sans font-light leading-relaxed"
      >
        Many exceptional companies lose opportunities because their digital
        presence fails to reflect the quality of their work. We close that gap.
      </p>
    </div>
  </section>
  ...
  >
    <div class="max-w-4xl mx-auto">
      ...
      >
        An outdated website, a weak first impression, inconsistent branding, and
        poor conversion are quietly costing you credibility and revenue every
        single day.
      </p>
      <p
        class="text-lg md:text-xl text-white/50 font-sans font-light leading-relaxed mt-12 reveal"
      >
        Your digital presence is the first impression most prospects will ever
        have of your company. If it does not communicate quality, trust, and
        capability within seconds, they will not wait around for you to explain.
      </p>
    </div>
  </section>
  ...
  >
    ...
    <div class="max-w-4xl mx-auto text-center relative z-10">
      ...
      >
        Trust before<br />
        <span class="italic text-white/40">the first conversation.</span>
      </h2>
      <p
        class="text-lg md:text-xl text-white/50 font-sans font-light leading-relaxed mt-8 max-w-3xl mx-auto reveal"
      >
        When your website and brand reflect the true quality of your work, you
        stop spending time explaining your credibility. Prospects arrive
        pre-qualified, pre-convinced, and ready to move forward. Your presence
        becomes your most effective sales asset.
      </p>
    </div>
  </section>
