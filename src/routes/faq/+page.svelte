<script>
  ...
  import {
    ...
    metaAdsFaqs,
    homepageFaqs,
  } from "$lib/data/faqItems.svelte.js";
...
<div class="bg-[#050505] text-white">
  ...
  >
    ...
    <div class="max-w-5xl mx-auto text-center relative z-10">
      ...
      >
        Common<br /><span class="italic text-white/40">Questions</span>
      </h1>
      <p
        id="hero-subline"
      ...
      <div class="flex flex-col">
        {#each homepageFaqs as item, index}
          <div class="w-full border-b border-white/10 py-8 text-left">
            ...
            <p
              class="pt-4 text-lg text-white/50 font-sans font-light leading-relaxed max-w-2xl whitespace-pre-line"
            >
              {item.a}
            </p>
          </div>
    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        {#each seoFaqs as item}
          ...
          >
            <div
              class="absolute -top-24 -left-24 w-48 h-48 bg-[#a08300] opacity-0 group-hover:opacity-[0.04] blur-[80px] rounded-full transition-opacity duration-700 pointer-events-none"
            ></div>
            <div class="relative z-10">
              <h3
                class="text-xl md:text-2xl font-serif text-white/80 group-hover:text-white transition-colors duration-300"
              >
                {item.question}
              </h3>
              <p
                class="mt-4 text-sm text-white/50 font-sans font-light leading-relaxed"
              >
                {item.answer}
              </p>
            </div>
            <div
              class="relative z-10 mt-6 flex items-center gap-2 text-xs font-mono text-white/40 uppercase tracking-widest group-hover:text-white transition-colors duration-500"
            >
              Read full answer <span
