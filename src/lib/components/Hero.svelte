...
>
  ...
  >
    <img
      src="/made-in-haiphong-hero.gif"
      alt="Made in Haiphong hero background"
      class="w-full h-screen object-cover mix-blend-screen opacity-[0.75] block"
    />
    <div
  ...
  >
    ...
    >
      The gap between a good company and a market leader is perception. We close
      it through positioning, brand, content, and digital presence that make the
      right people notice, remember, and choose you.
    </p>

    <div bind:this={ctaContainer} class="mt-8 flex gap-4 z-20">
      <a
        href="#work"
        class="px-8 py-4 bg-white text-black rounded-full font-sans font-medium hover:bg-[#a08300] hover:text-white transition-all duration-500 cursor-pointer shadow-[0_0_40px_rgba(255,255,255,0.15)] inline-block"
      >
        View Selected Works
      </a>
      <a
        href="services"
        class="hidden md:inline-block px-8 py-4 bg-transparent text-white border border-white/20 rounded-full font-sans font-medium hover:bg-[#a08300] hover:border-[#a08300] transition-all duration-500 cursor-pointer"
      >
        Our Services
      </a>
    </div>
