  ...
  const feedbacks = [
    {
      name: "Sarah Jenkins",
      role: "CMO, Lumina",
      text: "Made in Haiphong didn't just build a website; they architected a digital reality. Their motion mastery and craftsmanship are unmatched.",
    },
    {
      name: "Marcus Thorne",
      role: "Founder, Nexal",
...
>
  ...
  <div
    class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-200 h-125 bg-[#3B82F6]/5 blur-[200px] rounded-full pointer-events-none"
  ></div>
  ...
  >
    ...
    <h3
      bind:this={quoteRef}
      class="text-3xl md:text-5xl lg:text-6xl font-serif text-white/90 leading-[1.3] md:leading-[1.2] tracking-tight mb-16 flex items-center justify-center will-change-transform h-50 md:h-auto"
    >
